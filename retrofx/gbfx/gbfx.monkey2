...
Class GBFX Extends RetroFX
	...
	Method New (width:Int = 160, height:Int = 144, centered:Bool = True, palette_enabled:Bool = True, dither_enabled:Bool = True, brightness:Float = 0.0, contrast:Float = 0.0)

		Super.New ("Game Boy", width, height, palette_enabled, dither_enabled, centered)
	...
	Method InitShader (palette_enabled:Bool, dither_enabled:Bool, brightness:Float, contrast:Float)
		...
		TargetImage.Material.SetInt		("PaletteMode",		RetroFXPalette.MARCO_GAMEBOY5)
